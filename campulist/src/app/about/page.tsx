...
export default function AboutPage() {
  return (
    <div className="px-4 py-3"> {/* 간격 압축: py-6 → py-3 */}
      ...
      <section className="space-y-2"> {/* 간격 압축: space-y-4 → space-y-2 */}
        <div>
          <h2 className="text-lg font-bold">서비스 소개</h2>
          <p className="mt-1 text-sm leading-relaxed text-foreground/80"> {/* 간격 압축: mt-2 → mt-1 */}
        ...
        <div>
          ...
          <ul className="mt-1 space-y-1 text-sm text-foreground/80"> {/* 간격 압축: mt-2 → mt-1, space-y-2 → space-y-1 */}
      ...
      <section className="space-y-1.5 text-sm text-muted-foreground"> {/* 간격 압축: space-y-3 → space-y-1.5 */}
      ...
      <p className="mt-3 text-xs text-muted-foreground"> {/* 간격 압축: mt-6 → mt-3 */}
