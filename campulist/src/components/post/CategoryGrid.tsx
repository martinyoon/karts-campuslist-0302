...
export default function CategoryGrid({ universitySlug, activeSlug }: CategoryGridProps) {
  return (
      ...
      {majorCategories.map(cat => {
        ...
        return (
          <Link
            ...
            className={`flex min-w-[4.5rem] flex-1 flex-col items-center gap-1 rounded-xl border py-2 transition-all hover:scale-105 ${isActive ? 'border-blue-500 bg-blue-500/10' : 'border-border hover:border-blue-500/50 hover:bg-blue-500/5'}`} /* 간격 압축: gap-2 → gap-1, py-4 → py-2 */
          >
