...
### 32. 캠톡 퀵 메시지 개선 + 회원 유형 라벨 정비 (2026-02-24)

**커밋**: `60ba47e`, `5e24e65`

#### 캠톡 퀵 메시지 (`PostBottomAction.tsx`)
...
**브레드크럼에 "· 전체보기" 표시** — 소분류 미선택 시 대분류명 옆에 표시
- 소분류 미선택: `모든 대학 › 📦 중고마켓 · 전체보기`
- 소분류 선택: `모든 대학 › 📦 중고마켓 › 전공서적/교양도서`
- 대학별: `모든 대학 › 서울대 › 📦 중고마켓 · 전체보기`

**브레드크럼 대분류 링크 개선**
- 소분류 선택 시: 대분류명 클릭 → 소분류 필터 해제 (기존과 동일)
- 소분류 미선택 시: 대분류명은 볼드 텍스트로 표시 (현재 위치)
